# Generated by Django 4.2 on 2023-05-21 07:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aula', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turma.aula')),
            ],
        ),
        migrations.AddField(
            model_name='aula',
            name='turma',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turma.turma'),
        ),
    ]
